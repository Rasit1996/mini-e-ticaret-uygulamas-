...
using HayzumTicaret.UI.Models.Mapping;

namespace HayzumTicaret.UI.Models
{
    public partial class Db01_eTicaretContext : DbContext
    {
        static Db01_eTicaretContext()
        {
            Database.SetInitializer<Db01_eTicaretContext>(null);
        }

        public Db01_eTicaretContext()
            : base("Name=Db01_eTicaretContext")
        {
        }
        ...
        public DbSet<SiparişDurumu> SiparişDurumu { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new SiparişDurumuMap());
